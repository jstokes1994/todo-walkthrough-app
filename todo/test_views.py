...
class TestViews(TestCase):
    def test_get_home_page(self):
        ...
        # Ensures the pretend view has a 200 page code
        self.assertEqual(page.status_code, 200)
        # Ensures that the URL uses the correct template
    ...
    def test_get_edit_item_page(self):
        # This creates an item to put in the db
        item = Item(name='Create a Test')
        # This saves the item to the db and provides an id - saved in a test db
        item.save()
