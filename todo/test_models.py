...
class TestItemModel(TestCase):
    # If the 'done' section is not specified it should default to false - specified in model
    def test_done_defaults_to_False(self):
        # Saved to test db (no done specified)
    ...
    def test_item_as_a_string(self):
        item = Item(name="Create a Test")
        # Testing instance is same name as the object
